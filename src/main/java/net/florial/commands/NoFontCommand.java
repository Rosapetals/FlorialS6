...
public class NoFontCommand extends BaseCommand {

    @CommandAlias("nofont")
    public void onFontOff(Player p) {

        p.setResourcePack("https://github.com/Florial-Development/Resource-Pack/raw/main/S6%20-%20no%20font11.zip");
